...
from optimizers.mezo_torch import *  # noqa: F403
...
class Server(object):
    def __init__(self, args, eval_loader, candidate_seeds, log_dir):
        ...
        self.tokenizer = add_vocab(self.tokenizer)  # noqa: F405
        ...
        self.model = GPT2(model= self.model, args= self.args, tokenizer= self.tokenizer)        
